...
SINGLE_IMAGE_DATASET_DIR = "./datasets/SingleImgTable"
PHASE = "test"
EXP_NAME = "exp_geocode_table"
MODELS_DIR = "./models"
BLENDER_DIR = os.path.expandvars("$BLENDER32")
# BLEND_FILE = "./blends/procedural_vase.blend"
...
def gc_single_image_inference(single_img_dataset_dir=SINGLE_IMAGE_DATASET_DIR, phase=PHASE, exp_name=EXP_NAME, models_dir=MODELS_DIR):
...
gc_single_image_inference(SINGLE_IMAGE_DATASET_DIR, PHASE, EXP_NAME, MODELS_DIR)
